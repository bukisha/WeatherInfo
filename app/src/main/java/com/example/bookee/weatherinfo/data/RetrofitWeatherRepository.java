...
public class RetrofitWeatherRepository implements WeatherRepository{
    ...
    public void  fetchWeatherForCity(String city, final ForecastCallback callback) {
        ...
        call.enqueue(new Callback<CityForecastInfo>() {//todo primetices da ti ovaj CityForecastInfo svuda figurise i onda ga ti na 6-7 mesta prebacujes u TemperatureData. Sta mislis da ga odma ovde prebacis u TemperatureData i to i vratis!? Na taj nacin CityForecastInfo nikada ne izadje iz paketa *.data
            @Override
